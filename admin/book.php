...
mysql_select_db($database_breakcon, $breakcon);
$query_rs_prev = "SELECT * FROM service_book,mechanic,area,register WHERE service_book.mech_code=mechanic.mech_code and mechanic.acode=area.acode and service_book.regno=register.regno and service_book.status='Booked'";
...
<div class="container">
  ...
  <div class="well-sm" align="center" style="font-family:Constantia, 'Lucida Bright', 'DejaVu Serif', Georgia, serif;font-size:18px; color:#F8F8FE;background-color:#F55BFF">Service Booking</div>
        ...
        <tbody>
         <?php do { ?>
          <tr>
           ...
           <td><a href="service_response.php?bno=<?php echo $row_rs_prev['bookno']; ?>">Service Response
           </a></td>
    ...
    <?php } else { ?>
    <h1 align="center"> No Service Booking </h1>
    <?php }?>
