...
mysql_select_db($database_breakcon, $breakcon);
$query_Recordset2 = "SELECT * FROM hospital,register where hospital.acode=register.acode";
      ...
      <table class="table table-bordered table-hover">
       ...
       <thead> 
        ...
        <tbody>
         <?php do { ?>
          <tr>
            <td><?php echo $row_Recordset2['hspt_code']; ?></td>
            <td><?php echo $row_Recordset2['doc_name']; ?></td>
            <td><?php echo $row_Recordset2['acode']; ?></td>
            <td><?php echo $row_Recordset2['hspt_name']; ?></td>
